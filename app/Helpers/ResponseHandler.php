        ...
        switch ($language) {
            case 'Ar':
                return [
                    ...
                    'FoodSharingMarkerCreationForbiddenMessage' => 'أنت لا تملك صلاحية تعديل هذا العنصر',
            ...
            default:
                return [
                    ...
                    'FoodSharingMarkerCreationForbiddenMessage' => 'You aren\'t authorized to update this marker',
