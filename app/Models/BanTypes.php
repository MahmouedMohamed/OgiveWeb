...
abstract class BanTypes
{
    ...
    const ViewPet = 'view_pet_ban';                             //Implemented

    const CreatePet = 'create_pet_ban';                             //Implemented

    const UpdatePet = 'update_pet_ban';                             //Implemented

    const DeletePet = 'delete_pet_ban';                             //Implemented
}
