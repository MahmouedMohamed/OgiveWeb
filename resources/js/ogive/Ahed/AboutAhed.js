                ...
                <div className="col-md-12">
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={4} align="center">
                            <img src="https://www.baheya.org/front/img/vision.png" loading="lazy" className="rounded-circle" />
                            <Typography variant="h4" align="center">رؤيتنا</Typography>
                            <p>مؤسسة بهية هي المقصد الأول لصحة وسلامة المرأة</p>
                        </Grid>
                        <Grid item xs={4} align="center">
                            <img src="https://www.baheya.org/front/img/mission.png" loading="lazy" className="rounded-circle" />
                            <Typography variant="h4" align="center">رسالتنا</Typography>
                            <p>مؤسسة بهية هي المقصد الأول لصحة وسلامة المرأة</p>

                        </Grid>
                        <Grid item xs={4} align="center">
                            <img src="https://www.baheya.org/front/img/goal.png" loading="lazy" className="rounded-circle" />
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={6}>
                            <Paper>
                                <img src="/img/follow.png" loading="lazy" width="500" height="267" className="rounded" />
                            </Paper>
                        </Grid>
                        <Grid item xs={6} className="text-center">
                            ...
                            <Box my={7}>
                                <Typography variant="h4" >
                                    تابع التبرعات الخاصة بك
                                    مجموع ما تم التبرع به
                                </Typography>
                            </Box>
                            {/* </Paper> */}
                        </Grid>
